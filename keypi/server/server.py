...
class KeyPiService(dbus.service.Object):
    """
    ...
    def __init__(self):
        ...
        bus_name = dbus.service.BusName('com.jonkeane.keypiservice',
                                        bus=dbus.SystemBus())
        dbus.service.Object.__init__(self, bus_name, '/com/jonkeane/keypiservice')
    ...
    @dbus.service.method('com.jonkeane.keypiservice',
                         in_signature='ay')
